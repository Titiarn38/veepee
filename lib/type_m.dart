...
class type_m extends StatefulWidget {
  const type_m({super.key, required this.title});
  ...
  @override
  State<type_m> createState() => _type_mState();
}

class _type_mState extends State<type_m> {
  int _counter = 0;
